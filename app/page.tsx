            ...
            <div className="grid gap-6 lg:grid-cols-[1fr_400px] lg:gap-12 xl:grid-cols-[1fr_600px]">
              <div className="flex flex-col justify-center space-y-4">
                <div className="space-y-2">
                  ...
                  <FadeIn delay={2500} duration={800}>
                    <p className="text-xl text-muted-foreground">Full Stack Developer</p>
                  </FadeIn>
                </div>
                <FadeIn delay={3000} duration={800}>
                ...
                <StaggeredFadeIn delay={3500} stagger={200} duration={600}>
              ...
              <FadeIn delay={1000} duration={1000} direction="right">
            ...
            <FadeIn delay={200} duration={800}>
              <div className="mx-auto flex max-w-[58rem] flex-col items-center justify-center gap-4 text-center">
                ...
                <p className="max-w-[85%] leading-normal text-muted-foreground sm:text-lg sm:leading-7">
                  I'm a creative and proactive person with strong teamwork and problem-solving skills. I'm known for
                  being responsible, adaptable, and motivated to contribute to meaningful projects. I value continuous
                  learning and always look for opportunities to grow and deliver solid, effective results.
                </p>
              </div>
            </FadeIn>
          </div>
                ...
                <div className="relative pl-8 border-l-2 border-muted-foreground/20 pb-10">
                  ...
                  <div className="space-y-3">
                    ...
                    <p className="text-muted-foreground">
                      ...
                      Boot. Contributed to interface design, usability improvements, and worked within agile sprints
                      using CI tools.
                    </p>
                    <div className="flex flex-wrap gap-2 pt-2">
                      <Badge variant="secondary">Angular</Badge>
                ...
                <div className="relative pl-8 border-l-2 border-muted-foreground/20">
                  ...
                  <div className="space-y-3">
                    ...
                    <p className="text-muted-foreground">
                      ...
                      Supported both frontend and backend tasks, and used tools like Kendo, Liquibase, and Bootstrap in
        ...
        <section id="skills" className="py-12 md:py-24 lg:py-32 relative">
          ...
          <div className="container max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <StaggeredFadeIn
              ...
              stagger={200}
              duration={600}
              className="grid gap-4 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 max-w-5xl mx-auto"
            >
